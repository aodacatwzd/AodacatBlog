    ...
    Prism = function () {
        var e = /\blang(?:uage)?-(\w+)\b/i, t = 0, n = _self.Prism = {
            ...
            highlightElement: function (t, r, a) {
                ...
                var s = t.textContent, g = {element: t, language: l, grammar: i, code: s};
                    ...
                    for (var c = 0; c < u.length; ++c) {
                        ...
                        for (var b = a, k = l; b < t.length; k += t[b].length, ++b) {
                            ...
                            if (!(w instanceof s)) {
                                ...
                                if (_) {
                                    d && (p = _[1].length);
                                    var A = _.index + p, _ = _[0].slice(p), j = A + _.length, S = w.slice(0, A),
                                        C = w.slice(j), M = [b, P];
...
!function () {
    "undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function () {
        ...
        Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
            for (var s, a = t.getAttribute("data-src"), n = t, r = /\blang(?:uage)?-(?!\*)(\w+)\b/i; n && !r.test(n.className);) n = n.parentNode;
            ...
            i.open("GET", a, !0), i.onreadystatechange = function () {
                4 == i.readyState && (i.status < 400 && i.responseText ? (l.textContent = i.responseText, Prism.highlightElement(l)) : l.textContent = "✖ Error: File does not exist or is empty")
            }, i.send(null)
        })
